Todo = {
  ...
  setUser: function(options){       // sets up USER after url change
      var token = options.token;
      var id    = options.id;
      
      var tobeJSON = JSON.stringify({api_token: token, email: null, id: id, todos: null});
      Todo.USER = jQuery.parseJSON(tobeJSON);
  },
